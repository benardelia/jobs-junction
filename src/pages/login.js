  ...
  return (
    <div className='flex w-full font-sans'>
      ...
      <div className="flex w-full sm:w-2/3 items-center justify-center min-h-screen bg-blue-50">
        <Link to="/jobs-junction"><div className='flex absolute top-8 text-gray-900 sm:text-gray-100 left-4 items-center'><IoArrowBack />Home</div></Link>
        <div className=" py-4 px-8 space-y-14 bg-white rounded-lg justify-center shadow-xl w-4/5 h-3/4 my-auto sm:w-1/2 m-auto sm:h-4/5">
          <h2 className="text-xl font-bold font-sans text-center text-slate-800">Login</h2>
          <form onSubmit={handleSubmit} className="space-y-10 my-auto ">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-1 mt-1 h-12 sm:h-8 text-md sm:text-xs border border-gray-300 rounded-lg
   focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-1 mt-1 text-lg sm:text-xs h-12 sm:h-8 border border-gray-300 rounded-lg
   focus:outline-none focus:ring-2 focus:ring-blue-400"
              />
            </div>
            <button
              type="submit"
              className="w-full px-8 py-2 text-white bg-slate-700 text-md sm:text-xs h-12 sm:h-8 rounded-md hover:bg-slate-800
